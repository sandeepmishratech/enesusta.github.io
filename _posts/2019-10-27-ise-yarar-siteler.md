---
title: Bilgisayar dünyasına dair içerikler 
tags: 
style: fill
color: warning 
...
- [Linux](#linux)
- [Toplu Kaynaklar](#toplu-kaynaklar)
- [Software Craftsmanship](#software-craftsmanship)
- [Web](#web)
- [Java](#java)
- [Programming Tips&Tricks](#programming-tipstricks)
- [Tools](#tools)
...
- [Network](#network)
- [Regex](#regex)
- [RDMS (Relational Database Management System)](#rdms-relational-database-management-system)
- [Pastebin](#pastebin)
- [Deployment for MySQL](#deployment-for-mysql)
- [Low-Level Graphics](#low-level-graphics)
- [Online Learning and Practice](#online-learning-and-practice)
- [Education](#education)
- [Gereksiz ama eglenceli](#gereksiz-ama-eglenceli)


## Misyon

İçerik Trakya Üniversitesi **Bilgisayar Mühendisliği** öğrencilerinin oluşturduğu **Software Craftsmanship Topluluğu** tarafından eklenmektedir.
Rutin işlerin tamamlanması hususunda yardımcı olabilecek kaynakların eklenmesi.
Destek olmak isterseniz, lütfen [repoyu](https://github.com/enesusta/ise-yarar-siteler) forklayıp pull request atınız.
